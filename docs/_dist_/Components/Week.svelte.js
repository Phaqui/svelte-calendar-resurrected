import './Week.svelte.css.proxy.js';
/* src/Components/Week.svelte generated by Svelte v3.41.0 */
import {
	SvelteComponent,
	add_render_callback,
	append,
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			t0 = text(t0_value);
			t1 = space();
			attr(button, "class", "day--label svelte-m1xyrz");
			...
			attr(div, "class", "day svelte-m1xyrz");
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "week svelte-m1xyrz");
		},
		m(target, anchor) {
			insert(target, div, anchor);
